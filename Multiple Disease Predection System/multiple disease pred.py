# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 12:05:32 2023
...
diabetes_model = pickle.load(open('C:/Users/asus/Desktop/Multiple Disease Predection System/saved models/diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('C:/Users/asus/Desktop/Multiple Disease Predection System/saved models/heart_disease_model.sav','rb'))

parkinson_model = pickle.load(open('C:/Users/asus/Desktop/Multiple Disease Predection System/saved models/parkinsons_model.sav', 'rb'))

medicines_dict = pickle.load(open('C:/Users/asus/Desktop/Multiple Disease Predection System/saved models/medicine_dict.pkl', 'rb'))
medicines = pd.DataFrame(medicines_dict)

similarity = pickle.load(open('C:/Users/asus/Desktop/Multiple Disease Predection System/saved models/similarity.pkl', 'rb'))
...
def show_parkinsons_page():
    st.title("Parkinson's Prediction Page")
    
def show_medicines_dict_page():
    st.title("Medicine Recommendation Page")

#adding sidebar
with st.sidebar:
    selected = st.selectbox(
        'HealthCare Recommendation System',
        ['Diabetes Prediction', 'Heart Disease Prediction', 'Parkinsons Prediction', 'Medicine Recommended']
    )
...
if selected == "Medicine Recommended":
    st.title("Medicine Recommendation using ML")
